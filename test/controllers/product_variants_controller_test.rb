...
class ProductVariantsControllerTest < ActionController::TestCase
  ...
  test "should create product_variant" do
    assert_difference('ProductVariant.count') do
      post :create, product_variant: { product_id: @product_variant.product_id, quantity: @product_variant.quantity, size_id: @product_variant.size_id }
    end
  ...
  test "should update product_variant" do
    patch :update, id: @product_variant, product_variant: { product_id: @product_variant.product_id, quantity: @product_variant.quantity, size_id: @product_variant.size_id }
    assert_redirected_to product_variant_path(assigns(:product_variant))
  end
